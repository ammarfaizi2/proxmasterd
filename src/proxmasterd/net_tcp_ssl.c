...
// static int __pm_net_tcp_ssl_client_send_cb(struct pm_net_tcp_ssl_client *ssl_c,
...
// 	if (ssl_sbuf->len) {
// 		ret = __pm_net_tcp_ssl_client_send_cb(ssl_c, c);
// 		if (ret < 0 && ret != -EAGAIN)
// 			return ret;
// 	}
...
// 		switch (SSL_get_error(ssl_c->ssl, ret)) {
// 		case SSL_ERROR_WANT_READ:
// 			return pm_net_tcp_ssl_client_send_cb(ssl_c, c);
// 		case SSL_ERROR_WANT_WRITE:
// 			return -EAGAIN;
// 		default:
// 			return -EIO;
